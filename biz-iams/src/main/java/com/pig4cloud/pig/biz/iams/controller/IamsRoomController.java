...
public class IamsRoomController {
	...
	public R getIamsRoomPage(@ParameterObject Page page, @ParameterObject IamsRoomEntity iamsRoom) {
		...
		wrapper.like(StrUtil.isNotBlank(iamsRoom.getName()), IamsRoomEntity::getName, iamsRoom.getName());
		wrapper.like(StrUtil.isNotBlank(iamsRoom.getLocation()), IamsRoomEntity::getLocation, iamsRoom.getLocation());
		wrapper.like(StrUtil.isNotBlank(iamsRoom.getManager()), IamsRoomEntity::getManager, iamsRoom.getManager());
